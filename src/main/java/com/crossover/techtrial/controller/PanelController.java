...
public class PanelController {
    ...
    public ResponseEntity<?> registerPanel(@RequestBody PanelDto panel) {
    ...
    public ResponseEntity<?> saveHourlyElectricity(
        ...
        return ResponseEntity.accepted().body(hourlyElectricityService.save(hourlyElectricity, panelSerial));
    }
    ...
    public ResponseEntity<?> hourlyElectricity(
        ...
        PanelDto panel = panelService.findBySerial(panelSerial);
        if (panel == null) {
            return ResponseEntity.notFound().build();
        }
        Page<HourlyElectricity> page
                = hourlyElectricityService.getAllHourlyElectricityByPanelId(panel.getId(), pageable);
    ...
    public ResponseEntity<List<DailyElectricity>> allDailyElectricityFromYesterday(
        ...
        List<DailyElectricity> dailyElectricityForPanel = 
                this.hourlyElectricityService.getAllDailyElectricityFromYesterday(panelSerial);
